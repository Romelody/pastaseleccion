( function(){
  ...
  var metTabs = {
    ...
    evento: function(e){
      ...
      propTabs.contenid_activo = this.getAttribute('href');
      document.querySelector(propTabs.contenid_activo).className = 'active';
      document.querySelector(propTabs.contenid_activo).style.opacity = '0'
  
      setTimeout(() => {
        document.querySelector(propTabs.contenid_activo).style.opacity = '1'
